...
const deData = {
    translation: {
        ...
        STOP_MESSAGE: '<speak><say-as interpret-as="interjection">bis bald</say-as>.</speak>',
        ...
        NO_NEXT_RECIPE_START: '<speak>Prima! ',
        NO_NEXT_RECIPE_IMPROVEMENT: 'Du hast den <lang xml:lang="en-US">Nutri Score</lang> dieses Rezepts von <emphasis>{{oldScore}}</emphasis> auf <emphasis>{{newScore}}</emphasis> verbessert.',
        NO_NEXT_RECIPE_REDUCTION: '{{ intro }} dir in etwa {{reduce}} Kilojoule.',
