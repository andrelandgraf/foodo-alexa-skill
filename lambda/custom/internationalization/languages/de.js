...
const deData = {
    translation: {
        ...
        LAUNCH_REPROMT: '<speak>Wenn du nicht weißt, was du gerne essen willst, kannst du mich gerne fragen, welche <phoneme alphabet="ipa" ph="ʁeˈt͡sɛptə">Rezepte</phoneme>  ich kenne.</speak>',
        RECIPE_MESSAGE: 'Ich kenne folgende <phoneme alphabet="ipa" ph="ʁeˈt͡sɛptə">Rezepte</phoneme>.',
        RECIPE_REPROMT: '<speak>Wenn du alle <phoneme alphabet="ipa" ph="ʁeˈt͡sɛptə">Rezepte</phoneme> kennenlernen möchtest, dann besuche doch unsere Website.</speak>',
        NEXT_RECIPE_MESSAGE: 'Zur Auswahl stehen:',
        ...
        COOKING_REPROMT: '<speak>Sag ja, wenn du dein <phoneme alphabet="ipa" ph="ʁeˈt͡sɛpt">Rezept</phoneme> verbessern willst, oder nein, wenn du es beibehalten möchtest. Du kannst auch auf unsere Website gehen und weitere Substitute Optionen nutzen.</speak>',
        SELECT_SUBSTITUTE_MESSAGE: '1,2,3',
        SUBSTITUTE_MESSAGE: '1,2,3',
        ...
        // '<speak><voice name="Hans"><prosody rate="x-slow" volume="x-loud">Kar <s /> tof <s />
        // fäln</prosody>,<s /> <prosody rate="fast" volume="loud">man brät sie, stampft sie, tut
        // sie in die Suppe</prosody>. <p /> Da könnte nicht einmal einer wie <prosody rate="slow"
        // pitch="high">du</prosody>, nein sagen</voice></speak>',
        POTATOE_REPROMPT: 'Oh doch, wir könnten, gib ihn uns roh, frisch und zappelnd und behalte garstige Bratkartoffeln.',
    },
};
