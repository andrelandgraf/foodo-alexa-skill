const enData = {
    translation: {
        ...
        NO_NEXT_RECIPE: '<speak>Ok great! You improved this recipe from a Nutri Score of <emphasis>{{ oldScore }}</emphasis> to a Nutri Score of <emphasis>{{ newScore }}</emphasis>. Additionally, you are saving about {{ reduce }} Kilo Joules. Enjoy your healthy meal!</speak>',
